  ...
  return (
    <div className='flex flex-col justify-center items-center min-h-screen text-center p-6'>
        ...
        >
            ...
            <h1 className='text-4xl md:text-5xl text-green-700 font-extrabold'>Snapcart</h1>
        ...
        initial= {{
            ...
            >
            Your one-stop destination for freash groceris, organic produce and daily essential delivered right to your doorsteps.
        </motion.p>
        ...
        initial= {{
            ...
            className='inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-semibold px-8 py-3 rounded-2xl shadow-md transition-all duration-200 mt-10'
            onClick={()=>nextStep(2)}>
                Next
                <ArrowRight/>
        </motion.button>
